...
public class AliRtcChatActivity extends AppCompatActivity {
    ...
    private AliRtcAuthInfo userInfo = null; //房间配置参数
    ...
    public void setUserInfo(AliRtcAuthInfo userInfo)
    {
    ...
    private void joinChannel() {
        ...
        mAliRtcEngine.joinChannel(this.userInfo, "xxx");
